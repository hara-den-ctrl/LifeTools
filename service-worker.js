const CACHE="healthtools-v1.1.1";const CORE=["./","./index.html","./styles.css?v=1.1.1","./seasoning-db.js?v=1.1.1","./app.js?v=1.1.1","./product-scan.js?v=1.1.1","./vendor/html5-qrcode.min.js?v=1.1.1","./vendor/tesseract.min.js?v=1.1.1","./vendor/worker.min.js","./vendor/lang/jpn.traineddata.gz","./vendor/tesseract-core/tesseract-core.js","./vendor/tesseract-core/tesseract-core.wasm","./vendor/tesseract-core/tesseract-core-simd.js","./vendor/tesseract-core/tesseract-core-simd.wasm","./vendor/tesseract-core/tesseract-core-lstm.js","./vendor/tesseract-core/tesseract-core-lstm.wasm","./vendor/tesseract-core/tesseract-core-simd-lstm.js","./vendor/tesseract-core/tesseract-core-simd-lstm.wasm","./manifest.webmanifest","./version.json","./icon.svg"];
