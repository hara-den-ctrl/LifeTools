const CACHE="healthtools-v1.0.0";
const CORE=["./","./index.html","./styles.css?v=1.0.0","./seasoning-db.js?v=1.0.0","./app.js?v=1.0.0","./manifest.webmanifest","./version.json","./icon.svg"];
