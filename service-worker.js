const CACHE="healthtools-v1.0.1";
const CORE=["./","./index.html","./styles.css?v=1.0.1","./seasoning-db.js?v=1.0.1","./app.js?v=1.0.1","./manifest.webmanifest","./version.json","./icon.svg"];
