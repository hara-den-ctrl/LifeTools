const CACHE="healthtools-v0.8.3";
const CORE=["./","./index.html","./styles.css?v=0.8.3","./seasoning-db.js?v=0.8.3","./app.js?v=0.8.3","./manifest.webmanifest","./version.json","./icon.svg"];
