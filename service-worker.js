const CACHE="healthtools-v0.9.1";
const CORE=["./","./index.html","./styles.css?v=0.9.1","./seasoning-db.js?v=0.9.1","./app.js?v=0.9.1","./manifest.webmanifest","./version.json","./icon.svg"];
