const CACHE="healthtools-v1.1.2-flat";const CORE=["./","./index.html","./styles.css?v=1.1.2","./seasoning-db.js?v=1.1.2","./app.js?v=1.1.2","./product-scan.js?v=1.1.2","./html5-qrcode.min.js?v=1.1.2","./tesseract.min.js?v=1.1.2","./worker.min.js","./jpn.traineddata.gz","./tesseract-core.js","./tesseract-core.wasm","./tesseract-core-simd.js","./tesseract-core-simd.wasm","./tesseract-core-lstm.js","./tesseract-core-lstm.wasm","./tesseract-core-simd-lstm.js","./tesseract-core-simd-lstm.wasm","./manifest.webmanifest","./version.json","./icon.svg"];
